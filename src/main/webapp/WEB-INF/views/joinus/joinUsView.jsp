...
function goPopup(){
	...
	var pop = window.open("jusoPopup","pop", 'left='+(screen.availWidth-570)/2+',top='+(screen.availHeight-420)/2+', width=570px,height=420px', "width=570,height=420, scrollbars=yes, resizable=yes"); 
...
<div id="agree_02">
<form name="form" id="form" action="joinUsSelect" method="post" onsubmit="return check()">
<td>
