...
public class Notice_UserSelect_Dto {
	// field
	int nSeqno;
	String nTitle;
	String nContent;
	...
	// constructor
	public Notice_UserSelect_Dto() {
		// TODO Auto-generated constructor stub
	}

	
	public Notice_UserSelect_Dto(int nSeqno, String nTitle, String nContent, Timestamp nDate, String admin_adminId) {
		super();
		this.nSeqno = nSeqno;
		this.nTitle = nTitle;
