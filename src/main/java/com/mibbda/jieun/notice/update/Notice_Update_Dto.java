...
public class Notice_Update_Dto {
	// field
	int nSeqno;
	String nTitle;
	String nContent;
	...
	// constructor
	public Notice_Update_Dto() {
		// TODO Auto-generated constructor stub
	}

	
	public Notice_Update_Dto(int nSeqno, String nTitle, String nContent, Timestamp nDate, String admin_adminId) {
		super();
		this.nSeqno = nSeqno;
		this.nTitle = nTitle;
