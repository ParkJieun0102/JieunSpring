...
public class Notice_Register_Dto {
	// field
	int nSeqno;
	String nTitle;
	String nContent;
	...
	// constructor
	public Notice_Register_Dto() {
		// TODO Auto-generated constructor stub
	}

	
	public Notice_Register_Dto(int nSeqno, String nTitle, String nContent, Timestamp nDate, String admin_adminId) {
		super();
		this.nSeqno = nSeqno;
		this.nTitle = nTitle;
