...
<%@include file="../main/manaMain.jsp" %>
<body>
...
<form action="AdminNoticeSearch">
	...
	<table>
		...
		<c:forEach items="${NoticeAdminList}" var="dto" varStatus="status">
			...
			<tr>
				...
				<td><a href = "manaNoticeView?nSeqno=${dto.nSeqno}&nTitle=${dto.nTitle}&nDate=${dto.nDate}&admin_adminId=${dto.admin_adminId}">
				&nbsp;&nbsp;&nbsp;&nbsp;내용 수정</a></td>
				<td><a href="NoticDelete?nSeqno=${dto.nSeqno}"> &nbsp;&nbsp;&nbsp;&nbsp;X </a></td>
			</tr>
		</c:forEach>
	</table>
	<br>
