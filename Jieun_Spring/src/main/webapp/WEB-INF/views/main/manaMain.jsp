...
<h2>미쁘다 관리자 페이지</h2>
	...
	<a href="logOut.five">관리자 로그아웃</a>
         ...
         <br><div id="header2">
        	<div id="mainMenuBox1">
            	<ul id="menuItem1">
            	 <li><a href="manageNotice">공지사항 관리<div class="my01"></div></a></li>
            		<li><a href="manageUser">회원 관리<div class="my02"></div></a></li>
                    <li><a href="manageProduct">상품 관리<div class="my03"></div></a></li>
                    <li><a href="manageDelivery">배송 관리<div class="my04"></div></a></li>
                    <li><a href="manageEvent">이벤트 관리<div class="my05"></div></a></li>
                    <li><a href="oneToOneList">1:1문의 관리<div class="my06"></div></a></li>
